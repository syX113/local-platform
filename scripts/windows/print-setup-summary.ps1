...
Write-Host "  GitLab EDP orders project: $gitlabHttpUrl/root/$edpProjectPath"
Write-Host "  GitLab EDP customers project: $gitlabHttpUrl/root/$edpCustomersProjectPath"
...
Write-Host "  DEV EDP orders dbt project: $(Get-EnvValue -Name 'DEV_SNOWFLAKE_EDP_DBT_PROJECT') (deployed during initialization; executes into isolated branch/MR databases until CD deploy)"
Write-Host "  DEV EDP customers dbt project: $(Get-EnvValue -Name 'DEV_SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT') (deployed during initialization)"
Write-Host "  PRD source dbt project: $(Get-EnvValue -Name 'PRD_SNOWFLAKE_SDP_DBT_PROJECT')"
Write-Host "  PRD EDP orders dbt project: $(Get-EnvValue -Name 'PRD_SNOWFLAKE_EDP_DBT_PROJECT') (deployed during initialization; PRD database is created only after PRD CD deploy)"
Write-Host "  PRD EDP customers dbt project: $(Get-EnvValue -Name 'PRD_SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT') (deployed during initialization)"
