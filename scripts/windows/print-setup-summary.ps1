...
Write-Host "  GitLab EDP project: $gitlabHttpUrl/root/$edpProjectPath"
...
Write-Host "  Snowflake EDP database target: $(Get-EnvValue -Name 'SNOWFLAKE_EDP_DATABASE') (created on demand by EDP CI/CD)"
Write-Host "  DEV SDP dbt project: $(Get-EnvValue -Name 'DEV_SNOWFLAKE_SDP_DBT_PROJECT')"
Write-Host "  DEV EDP dbt project: $(Get-EnvValue -Name 'DEV_SNOWFLAKE_EDP_DBT_PROJECT') (deployed on demand by EDP CI/CD)"
Write-Host "  PRD SDP dbt project: $(Get-EnvValue -Name 'PRD_SNOWFLAKE_SDP_DBT_PROJECT')"
Write-Host "  PRD EDP dbt project: $(Get-EnvValue -Name 'PRD_SNOWFLAKE_EDP_DBT_PROJECT') (deployed on demand by EDP CI/CD)"
