...
printf '  Snowflake EDP database target: %s (created on demand by EDP CI/CD)\n' "${SNOWFLAKE_EDP_DATABASE}"
printf '  Snowflake EDP schemas: %s, %s, %s (created on demand by EDP CI/CD)\n' "${SNOWFLAKE_EDP_IN_SCHEMA}" "${SNOWFLAKE_EDP_CORE_SCHEMA}" "${SNOWFLAKE_EDP_ACC_SCHEMA}"
