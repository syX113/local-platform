...
x-common-env: &common-env
  ...
  DEV_SNOWFLAKE_SDP_DATABASE: ${DEV_SNOWFLAKE_SDP_DATABASE:-${SNOWFLAKE_SDP_DATABASE}}
  PRD_SNOWFLAKE_SDP_DATABASE: ${PRD_SNOWFLAKE_SDP_DATABASE}
  SNOWFLAKE_SDP_ORDERS_DATABASE: ${SNOWFLAKE_SDP_ORDERS_DATABASE}
  DEV_SNOWFLAKE_SDP_ORDERS_DATABASE: ${DEV_SNOWFLAKE_SDP_ORDERS_DATABASE:-${SNOWFLAKE_SDP_ORDERS_DATABASE}}
  PRD_SNOWFLAKE_SDP_ORDERS_DATABASE: ${PRD_SNOWFLAKE_SDP_ORDERS_DATABASE}
  SNOWFLAKE_SDP_CUSTOMERS_DATABASE: ${SNOWFLAKE_SDP_CUSTOMERS_DATABASE}
  DEV_SNOWFLAKE_SDP_CUSTOMERS_DATABASE: ${DEV_SNOWFLAKE_SDP_CUSTOMERS_DATABASE:-${SNOWFLAKE_SDP_CUSTOMERS_DATABASE}}
  PRD_SNOWFLAKE_SDP_CUSTOMERS_DATABASE: ${PRD_SNOWFLAKE_SDP_CUSTOMERS_DATABASE}
  SNOWFLAKE_SDP_TAXES_DATABASE: ${SNOWFLAKE_SDP_TAXES_DATABASE}
  DEV_SNOWFLAKE_SDP_TAXES_DATABASE: ${DEV_SNOWFLAKE_SDP_TAXES_DATABASE:-${SNOWFLAKE_SDP_TAXES_DATABASE}}
  PRD_SNOWFLAKE_SDP_TAXES_DATABASE: ${PRD_SNOWFLAKE_SDP_TAXES_DATABASE}
  SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE: ${SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE}
  DEV_SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE: ${DEV_SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE:-${SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE}}
  PRD_SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE: ${PRD_SNOWFLAKE_SDP_DEPOT_TRANSACTIONS_DATABASE}
  ...
  DEV_SNOWFLAKE_SDP_DBT_PROJECT: ${DEV_SNOWFLAKE_SDP_DBT_PROJECT:-DEV_DBT_PROJECT_SOURCE_FINNOVA}
  PRD_SNOWFLAKE_SDP_DBT_PROJECT: ${PRD_SNOWFLAKE_SDP_DBT_PROJECT:-PRD_DBT_PROJECT_SOURCE_FINNOVA}
  SNOWFLAKE_EDP_DATABASE: ${SNOWFLAKE_EDP_DATABASE}
  DEV_SNOWFLAKE_EDP_DATABASE: ${DEV_SNOWFLAKE_EDP_DATABASE:-${SNOWFLAKE_EDP_DATABASE}}
  PRD_SNOWFLAKE_EDP_DATABASE: ${PRD_SNOWFLAKE_EDP_DATABASE}
  SNOWFLAKE_EDP_ORDERS_DATABASE: ${SNOWFLAKE_EDP_ORDERS_DATABASE}
  DEV_SNOWFLAKE_EDP_ORDERS_DATABASE: ${DEV_SNOWFLAKE_EDP_ORDERS_DATABASE:-${SNOWFLAKE_EDP_ORDERS_DATABASE}}
  PRD_SNOWFLAKE_EDP_ORDERS_DATABASE: ${PRD_SNOWFLAKE_EDP_ORDERS_DATABASE}
  SNOWFLAKE_EDP_CUSTOMERS_DATABASE: ${SNOWFLAKE_EDP_CUSTOMERS_DATABASE}
  DEV_SNOWFLAKE_EDP_CUSTOMERS_DATABASE: ${DEV_SNOWFLAKE_EDP_CUSTOMERS_DATABASE:-${SNOWFLAKE_EDP_CUSTOMERS_DATABASE}}
  PRD_SNOWFLAKE_EDP_CUSTOMERS_DATABASE: ${PRD_SNOWFLAKE_EDP_CUSTOMERS_DATABASE}
  SNOWFLAKE_EDP_TAXES_DATABASE: ${SNOWFLAKE_EDP_TAXES_DATABASE}
  DEV_SNOWFLAKE_EDP_TAXES_DATABASE: ${DEV_SNOWFLAKE_EDP_TAXES_DATABASE:-${SNOWFLAKE_EDP_TAXES_DATABASE}}
  PRD_SNOWFLAKE_EDP_TAXES_DATABASE: ${PRD_SNOWFLAKE_EDP_TAXES_DATABASE}
  SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE: ${SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE}
  DEV_SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE: ${DEV_SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE:-${SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE}}
  PRD_SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE: ${PRD_SNOWFLAKE_EDP_DEPOT_TRANSACTIONS_DATABASE}
  ...
  SNOWFLAKE_EDP_DBT_PROJECT: ${SNOWFLAKE_EDP_DBT_PROJECT:-DEV_DBT_PROJECT_DOMAIN_TRANSACTIONS}
  DEV_SNOWFLAKE_EDP_DBT_PROJECT: ${DEV_SNOWFLAKE_EDP_DBT_PROJECT:-DEV_DBT_PROJECT_DOMAIN_TRANSACTIONS}
  PRD_SNOWFLAKE_EDP_DBT_PROJECT: ${PRD_SNOWFLAKE_EDP_DBT_PROJECT:-PRD_DBT_PROJECT_DOMAIN_TRANSACTIONS}
  SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT: ${SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT:-DEV_DBT_PROJECT_DOMAIN_CUSTOMER}
  DEV_SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT: ${DEV_SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT:-DEV_DBT_PROJECT_DOMAIN_CUSTOMER}
  PRD_SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT: ${PRD_SNOWFLAKE_EDP_CUSTOMERS_DBT_PROJECT:-PRD_DBT_PROJECT_DOMAIN_CUSTOMER}
