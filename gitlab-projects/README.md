...
- `gitlab-projects/generated/proj_domain_transactions`
- `gitlab-projects/generated/proj_domain_customer`
...
- A new non-default branch in `proj_domain_transactions` triggers creation of a branch-scoped Snowflake clone set.
- A new non-default branch in `proj_domain_customer` triggers creation of a branch-scoped Snowflake clone set.
